...
# Simulate 5 trials with 100 patients each (50 per arm)
df <- simulate_trials(
  baseline_means = c(25, 25, 25, 30, 35),     # Different mean baselines across trials
  trial_intercepts = c(0, 0, 0, -10, -15),    # Outcome levels lowered in Trials 4 and 5
  n_per_arm = 50,
  beta_W = 0,     # no within-trial effect modification
  beta_A = 0      # no across-trial effect modification
)
