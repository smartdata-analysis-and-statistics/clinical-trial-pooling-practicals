...
### Assessing Between-Trial Heterogeneity in Treatment Effects
...
ggplot(plot_df, aes(x = estimate, y = trial)) +
  ...
  labs(
    title = "Trial-Specific Intercepts and Treatment Effects",
    subtitle = "Red dashed line: 95% prediction interval for pooled treatment effect",
    x = "Estimate",
    y = NULL
  ) +
  theme_minimal()
