...
# Preparation (do this before you attend the course)
...
- `simulate_trials.R` You can download it from <https://github.com/smartdata-analysis-and-statistics/clinical-trial-pooling-practicals/> (or find it below)
